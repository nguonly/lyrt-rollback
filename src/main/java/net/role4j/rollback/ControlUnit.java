...
public class ControlUnit {
    ...
    /**
     * Log the error of the defective configuration and associated role types.
     * Developers can view the log and fix the bugs
     */
    ...
    /**
     * Provide a check condition whether the current adaptation configuration contains role types
     * that have been reported. These roles resemble bugs and should not be bound.
     * @return
     */
    public boolean isHavingDefectiveRoles(){
        //TODO: to be implemented
        return false;
    }
}
